...
class MotorController6wd
{

public:
  MotorController6wd();
    virtual ~MotorController6wd();
...
private:    //functions
    ...
    void serial_read_thrd_left();
    void serial_read_thrd_right();
...
//    ros::Publisher _pub;
    ...
    apps::SerialCom _serial_left;
    apps::SerialCom _serial_right;

    std::atomic<bool> _run;

    std::thread _thrd_left;
    std::thread _thrd_right;
